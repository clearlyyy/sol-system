...
function Callisto({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 1.883801220323989E+06 }
      initEC={ 7.184196428316506E-03 }
      initi={ 1.949923844891594E+00 }
      initomega={ 2.856253032554822E+01 }
      initOmega={ 3.367433492632588E+02 }
      initmeanMotion={ 2.494293474500411E-04 * 86400 }
