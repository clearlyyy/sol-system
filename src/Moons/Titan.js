...
function Titan({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 1.221933311251816E+06 }
      initEC={ 2.872544937441408E-02 }
      initi={ 2.771105839686493E+01 }
      initomega={ 1.773673254538171E+02 }
      initOmega={ 1.690722505978772E+02 }
      initmeanMotion={ 2.612769480370023E-04 * 86400 }
