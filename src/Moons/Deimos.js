...
function Luna({daysSinceJ2000,  hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 2.345970623300157E+04 }
      initEC={ 2.909257113435189E-04 }
      initi={ 2.423956367943092E+01 }
      initomega={ 3.497573115350104E+01 }
      initOmega={ 8.081223220483606E+01 }
      initmeanMotion={ 3.299928803366823E-03 * 86400 }
