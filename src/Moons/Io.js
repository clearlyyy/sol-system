...
function Io({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 4.220205293150642E+05 }
      initEC={ 3.503596852916024E-03 }
      initi={ 2.186097436945496E+00 }
      initomega={ 1.256224702817128E+02 }
      initOmega={ 3.381293433474519E+02 }
      initmeanMotion={ 2.352327060649512E-03 * 86400 }
