...
function Europa({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 6.712584086671803E+05 }
      initEC={ 9.490553938596196E-03 }
      initi={ 2.233867251662807E+00 }
      initomega={ 3.174765257330752E+02 }
      initOmega={ 3.260082520334616E+02 }
      initmeanMotion={ 1.172623887824027E-03 * 86400 }
