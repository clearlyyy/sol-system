...
function Tethys({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 2.949751791051294E+05 }
      initEC={ 8.911411663124575E-04 }
      initi={ 2.706616502216702E+01 }
      initomega={ 9.014278330273885E+01 }
      initOmega={ 1.685046602663736E+02 }
      initmeanMotion={ 2.202637277520926E-03 * 86400 }
