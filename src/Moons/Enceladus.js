...
function Enceladus({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 2.384086627716939E+05 }
      initEC={ 3.546069702422481E-03 }
      initi={ 2.804916130110298E+01 }
      initomega={ 3.357755833570890E+02 }
      initOmega={ 1.695372173787967E+02 }
      initmeanMotion={ 3.031363051897524E-03 * 86400 }
