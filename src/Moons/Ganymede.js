...
function Ganymede({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 1.070820128269964E+06 }
      initEC={ 1.747368801996100E-03 }
      initi={ 2.333442858120520E+00 }
      initomega={ 5.361905985804176E+00 }
      initOmega={ 3.394538398427119E+02 }
      initmeanMotion={ 5.820094209150526E-04 * 86400 }
