...
function Mimas({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 1.860122166254450E+05 }
      initEC={ 1.837040397107320E-02 }
      initi={ 2.935875624238190E+01 }
      initomega={ 2.948629186416495E+02 }
      initOmega={ 1.677003121499674E+02 }
      initmeanMotion={ 4.398542286095829E-03 * 86400 }
