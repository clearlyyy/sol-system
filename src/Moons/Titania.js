...
function Titania({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      A={ 4.362485548477788E+05 }
      EC={ 1.608099439302163E-03 }
      i={ 9.776492036094507E+01 }
      omega={ 2.845692494893340E+02 }
      Omega={ 1.676405589946448E+02 }
      meanMotion={ 4.786492413461645E-04 * 86400 }
