...
function Luna({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 9.379270986268926E+03 }
      initEC={ 1.474328572002532E-02 }
      initi={ 2.670531680335356E+01 }
      initomega={ 1.523533451538571E+01 }
      initOmega={ 8.524082427595087E+01 }
      initmeanMotion={ 1.305373529536435E-02 * 86400 }
