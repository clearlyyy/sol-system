...
function Miranda({daysSinceJ2000, hostPosition, userControlsRef, ...props}) {
  ...
  return loaded ? (
    <Moon
      ...
      initA={ 1.298713997716866E+05 }
      initEC={ 1.637504599856847E-03 }
      initi={ 1.004046294675958E+02 }
      initomega={ 3.727497436381719E+01 }
      initOmega={ 1.640791928071461E+02 }
      initmeanMotion={ 2.946726973429790E-03 * 86400 }
