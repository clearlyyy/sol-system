...
function Pluto({daysSinceJ2000, userControlsRef, ...props}) {
  const { delay = 0 } = props; // Default delay is 0 if not provided
    ...
    <Planet
      ...
      initA={ 5.932548642959757E+09 }
      initEC={ 2.501324112782218E-01 }
      initi={ 1.736678729503515E+01 }
      initomega={ 1.144829790737675E+02 }
      initOmega={ 1.104677676773093E+02 }
      initmeanMotion={ 4.567898962415817E-08 * 86400 }
