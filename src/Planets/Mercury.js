...
function Mercury({daysSinceJ2000, userControlsRef, ...props}) {
  const { delay = 0 } = props; // Default delay is 0 if not provided
    ...
    <Planet
      ...
      initA={ 5.790914908349126E+07 }
      initEC={ 2.056377211068672E-01 }
      initi={ 7.003482834458984E+00 }
      initomega={ 2.919709990340481E+01 }
      initOmega={ 4.829968514953469E+01 }
      initmeanMotion={ 4.736501839898613E-05 * 86400 }
