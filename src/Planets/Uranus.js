...
function Uranus({daysSinceJ2000, userControlsRef, ...props}) {
  const { delay = 0 } = props; // Default delay is 0 if not provided
    ...
    <Planet
      ...
      initA={ 2.887319030356802E+09 }
      initEC={ 4.578275341337535E-02 }
      initi={ 7.722278083166019E-01 }
      initomega={ 9.048538744812166E+01 }
      initOmega={ 7.402930173479820E+01 }
      initmeanMotion={ 1.345382485136898E-07 * 86400 }
