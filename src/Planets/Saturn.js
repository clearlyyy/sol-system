...
function Saturn({daysSinceJ2000, userControlsRef, ...props}) {
  const { delay = 0 } = props; // Default delay is 0 if not provided
    ...
    <Planet
      ...
      initA={ 1.429815962622609E+09 }
      initEC={ 5.537129625010676E-02 }
      initi={ 2.488916875118528E+00 }
      initomega={ 3.368250431033135E+02 }
      initOmega={ 1.136666573187736E+02 }
      initmeanMotion={ 3.861182175316644E-07 * 86400 }
