...
function Venus({daysSinceJ2000, userControlsRef, ...props}) {
  const { delay = 0 } = props; // Default delay is 0 if not provided
    ...
    <Planet
      ...
      initA={ 1.082091114849111E+08 }
      initEC={ 6.746020028596929E-03 }
      initi={ 3.394369649329146E+00 }
      initomega={ 5.506922965951486E+01 }
      initOmega={ 7.661172857123719E+01 }
      initmeanMotion={ 1.854313817536282E-05 * 86400 }
